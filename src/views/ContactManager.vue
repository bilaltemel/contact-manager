            ...
            <div class="col">
                <p class="h3 text-success fw-bold">Contact Manager
                    <router-link to="/contacts/add" class="btn btn-success btn-sm">
                        <i class="fa fa-plus-circle"></i> Yeni Kişi Ekle
                    </router-link>
                </p>
                <p class="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et tempora magnam rem
                    officia praesentium, iure aspernatur qui provident quibusdam a soluta numquam repellendus dolores
                    quaerat natus debitis non, exercitationem incidunt.</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
